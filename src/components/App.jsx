    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `https://api.searchspring.net/api/search/search.json?siteId=scmq7n&q=${query}&resultsFormat=native&resultsPerPage=18&page=${page}&sort=${sorting.field}=${sorting.direction}`
        );
